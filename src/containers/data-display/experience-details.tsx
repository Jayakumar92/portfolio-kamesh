import { ExperienceDetails as ExperienceDetailsProps } from "@/types"
...
const ExperienceDetails = ({
  ...
  return (
    <Card className="mx-auto flex w-full max-w-6xl flex-col justify-between gap-4 p-8 md:flex-row md:gap-8">
