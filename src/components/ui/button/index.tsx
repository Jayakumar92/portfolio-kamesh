...
import { Icon, IconProps, IconsName } from "@/components/ui/icon"
...
function ButtonIcon({ icon, variant = "outline", ...props }: ButtonIconProps) {
  return (
...
function ButtonWithIcon({
  ...
  return (
    <Button {...props}>
      <Icon
        {...iconProps}
        className={cn("mr-[5px] h-4 w-4", iconProps?.className)}
      />
      {children}
    </Button>
  )
...
function ButtonLoading({ children = "Please wait", ...props }: ButtonProps) {
  return (
    <Button {...props}>
...
export { Button, ButtonIcon, ButtonWithIcon, ButtonLoading, buttonVariants }
